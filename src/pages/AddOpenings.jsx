...
const AddOpenings = () => {
    ...
    const [openingArray, setOpeningArray] = useState([]);
    ...
    const terminateOpening = async () => {
        try {
            ...
            alert("Terminated Opening Creation")
        } catch (Error) {
    ...
    const getOpenings = async () => {
        // Check if openings are cached in localStorage
        ...
        if (cachedOpenings) {
            ...
            if (validOpenings.length > 0) {
                ...
                setOpeningArray(decodeOpening(validOpenings[index].openingSeq));
            }
        } else {
...
<div className="databaseButtons">
    <div className="yellowButton">
        <button className="button" onClick={branchOpenings} disabled = {isBranchClicked}>Branch Openings</button>
    </div>
    <div className="greenButton">
        <button className="button" onClick={terminateOpening} disabled = {isTerminateClicked}>Terminate Opening</button>
    </div>
